...
public:
  ...
  static ref<Expr> replaceReadExpr(ref<Expr> expr, const std::map< ref<Expr>, ref<Expr> > &replacements);
  static ref<Expr> replaceExpr(ref<Expr> expr, ref<Expr> src, ref<Expr> dst);
