...
/// Print "cuKLEE: ERROR: " followed by the msg in printf format and a
/// newline on stderr and to warnings.txt, then exit with an error.
void klee_error(const char *msg, ...)
    __attribute__((format(printf, 1, 2), noreturn));

/// Print "cuKLEE: " followed by the msg in printf format and a
...
/// Print "cuKLEE: WARNING: " followed by the msg in printf format and a
