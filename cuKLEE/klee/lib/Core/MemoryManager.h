...
private:
  ...
  kdalloc::AllocatorFactory sharedFactory;
  kdalloc::Allocator sharedAllocator;
...
public:
  ...
  MemoryObject *allocate(uint64_t size, bool isLocal, bool isGlobal,
                         ...
                         size_t alignment);
  MemoryObject *allocateShared(uint64_t size, ExecutionState *state, const llvm::Value *allocSite);
