...
#define HANDLER(name) void name(ExecutionState &state, \
    ...
    HANDLER(handleCudaMalloc);
    HANDLER(handleCudaMemcpy);
    HANDLER(handleCudaFree);
    HANDLER(handleCudaLaunchKernel);
    HANDLER(handleCudaPopCallConfiguration);
    HANDLER(handleCudaPushCallConfiguration);
    HANDLER(handleCudaDeviceSynchronize);
    HANDLER(handleCudaDeviceGetAttribute);
    HANDLER(handleCudaFuncSetAttribute);
    HANDLER(handleCudaMemcpyAsync);
#undef HANDLER
  };
} // End klee namespace
