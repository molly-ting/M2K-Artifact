...
python3 cuKLEE/run.py --input-dir=evaluation/section-6-1-bug-detection/small_dataset_results/vllm/input --cuklee-out-dir=cuKLEE/results-small/vllm/out --log-dir=cuKLEE/results-small/vllm/log
